  ...
  axSkill: [
    {
      title: "UI/UX",
      description:
        "I was trying to understand the process of building a program from the beginning of creating an idea to the end of the path. Of course, I am familiar with applications such as Adobe XD and have the ability to build wireframes and prototypes.",
      icon: <PaletteIcon />,
    },
    {
      title: "Git",
      description:
        "The Git is very wide, but I know the ability to do routine tasks such as working with branches, Mergin them, pull, push so on. In fact, it's the routine that is required of any programmer.I will certainly add to my knowledge in this area.",
      icon: <GitHubIcon />,
    },
    {
      title: "Data Structure & Algorithm",
      description:
        "Personally, I am very interested in this part of programming,I have implemented some structures, and I am familiar with others. Along with this content, I am trying to learn Design pattern. Patterns such as builder, strategy, observer, single ton and etc.",
